## Experiment 19 
## 
## Hypothesis: Sufficient statistic regularizers approximate large batch sizes  
...
def map1(task_idx):
    ...
    try:
        ...
        condition_0_model = Model(batch_size=30)
        ...
        ## set batch sizes 
        condition_3_model.batch_size = 100 
        condition_4_model.batch_size = 200
        condition_5_model.batch_size = 500 
        ...
        ## condition 3 (experimental): No use memory, do discard data, batch size = 100 
        #condition_3_model.clear_observations() 
        condition_3_result_tuples_after = condition_3_model.simulate(total_iters=ITERS, plot_prob_func=False, plot_rewards=False, silence_tqdm=True)
        ## condition 4 (experimental): No use memory, do discard data, batch size = 200 
        #condition_4_model.clear_observations() 
        condition_4_result_tuples_after = condition_4_model.simulate(total_iters=ITERS, plot_prob_func=False, plot_rewards=False, silence_tqdm=True)
        ## condition 5 (experimental): No use memory, do discard data, batch size = 500 
        #condition_5_model.clear_observations() 
        condition_5_result_tuples_after = condition_5_model.simulate(total_iters=ITERS, plot_prob_func=False, plot_rewards=False, silence_tqdm=True)

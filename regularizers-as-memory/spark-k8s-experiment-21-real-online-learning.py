## Experiment 21: Real online learning  
## 
## Hypothesis: online learning without restarting games and also with finite-dimensional memory  
...
def map1(task_idx):
    ...
    try:
        ...
        condition_3_result_tuples_after = condition_3_model.simulate(total_iters=ITERS, plot_prob_func=False, plot_rewards=False, silence_tqdm=True, memorization_frequency=200) 

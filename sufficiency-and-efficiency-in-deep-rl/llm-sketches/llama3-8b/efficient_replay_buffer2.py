...
class EfficientReplayBuffer(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        print(f'DEBUG 10: __getitem__({idx}) shapes: ({s_ta_tok.shape}, {s_ta_mask.shape}, {s_tp1_tok.shape}, {s_tp1_mask.shape}, {self.rewards[token_idx].shape}, {self.dones[token_idx].shape})')
        return s_ta_tok, s_ta_mask, s_tp1_tok, s_tp1_mask, self.rewards[token_idx].unsqueeze(0), self.dones[token_idx].unsqueeze(0)

...
class SSRAgent(nn.Module): 
    ...
    def __init__(self, replay_buffer, ssr_rank=2, gpu_saver=True, dt_mean_N=10): 
        ...
        ## your optimizer must be defined as the `.optimizer` attribute 
        ## please only select parameters with p.requires_grad as True 
        ## self.optimizer = ... ## TODO this interface stinks, at least document it better 
        pass 
    def ssr_dict(self): 

...
class ContinuousSpeechStream:
    ...
    def _load_sounddevice(self):
        try:
            ...
            raise RuntimeError("sounddevice is required for continuous speech streaming") from exc
        return sd
...
def _numpy():
    try:
        ...
        raise RuntimeError("numpy is required for continuous speech streaming") from exc
    return np
